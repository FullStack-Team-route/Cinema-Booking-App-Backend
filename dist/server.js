...
const API_RATE_WINDOW_MS = toNumber(process.env.RATE_LIMIT_WINDOW_MS, 15 * 60 * 1000); // default 15m
const API_RATE_MAX = toNumber(process.env.RATE_LIMIT_MAX, 300);
const LOGIN_RATE_WINDOW_MS = toNumber(process.env.LOGIN_RATE_LIMIT_WINDOW_MS, 15 * 60 * 1000);
const LOGIN_RATE_MAX = toNumber(process.env.LOGIN_RATE_LIMIT_MAX, 10);
const FORGOT_RATE_WINDOW_MS = toNumber(process.env.FORGOT_RATE_LIMIT_WINDOW_MS, 60 * 60 * 1000); // default 1h
